...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + {"0":"496775a8e9e92ba02d28"}[chunkId] + "." + chunkId + ".js";
...
let logic = __webpack_require__.e/* require.ensure */(0).then((() => {
  ...
  const { default: CatalogDemo } = __webpack_require__(38);
  customElements.define('catalog-demo', CatalogDemo);
  const { default: ControlPanel } = __webpack_require__(37);
